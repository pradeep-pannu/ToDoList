...
public class GetTaskFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday", "Favourite","End of Month" }));
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
       ...
       if(jFileChooser1.getSelectedFile()!=null)
        {
            link=jFileChooser1.getSelectedFile().toString();
        }
       String priority =(String)jComboBox2.getSelectedItem();
       String category = jTextField3.getText();
       String sub_cat = jTextField5.getText();
       String url = jTextField4.getText();
//       if(link.length()==0 || link.isEmpty() || link ==null)
//       {
//           this.setVisible(false);
//       }
//       else{
           TaskDetails task_new = new TaskDetails();
           task_new.setTask_day(day);
           task_new.setTask_name(task);
           task_new.setTask_type(type);
           task_new.setTask_link(link);
           task_new.setTask_category(category);
           task_new.setTask_priority(priority);
           task_new.setTask_sub_cat(sub_cat);
           task_new.setTask_url(url);
           Marshalling m_task = new Marshalling();
